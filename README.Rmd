...
The app can be launched with Docker without setting up any other dependency other than Docker. 

1. If you do not have Docker, install from [here](https://docs.docker.com/engine/install/).
